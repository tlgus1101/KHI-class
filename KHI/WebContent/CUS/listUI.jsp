			...
			<s:iterator value="list" status="stat">
				...
				<div class="bbs-list-row">
					...
					<div class="column bbs-title">
						<a
							href='CUSviewAction.action?q_num=<s:property value="q_num"/>&currentPage=<s:property value="currentPage"/>'>
	...
	<tr align="center">
		<td colspan="5">
			<div class="cm-btn-controls">
				<a href="javascript:location.href='CUSwriteForm.action?currentPage=<s:property value="currentPage"/>'"
